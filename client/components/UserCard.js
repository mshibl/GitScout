	...
	console.log(this.props)
		return(
		     <div className="card-container col-md-3">
		        <div className="card">
		                <div className="cover">
		                    <img src="https://i.ytimg.com/vi/d-zKJCKsoWw/maxresdefault.jpg"/>
		                </div>
		                <div className="user">
		                ...
		                <div className="content">
		                    <div className="main">
		                        ...
		                        <p className=""> <i className="fa fa-user-plus" aria-hidden="true"></i> Followers: {followers}</p>
		                        <p className=""> <i className="fa fa-users" aria-hidden="true"></i> Following: {following}</p>
